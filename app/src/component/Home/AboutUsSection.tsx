    ...
    return (
        <>
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <p className="text-lg mt-4">
                    Would you like to make a reservation? We would be happy to welcome your booking.
                </p>
                <p className="text-lg mt-4">
                    We also welcome you without a reservation and we can provide a table on a
